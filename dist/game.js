...
class GameRenderer {
    ...
    drawSelection(x, y, size, color) {
        const palette = ['#e63946', '#1d3557', '#2a9d8f', '#e9c46a', '#9b5de5', '#f4a261', '#00b4d8', '#95a5a6', '#ffffff'];
    ...
    drawHorse(color, size) {
        const colors = ['#c0392b', '#1d3557', '#27ae60', '#e9c46a', '#9b5de5', '#f4a261', '#1abc9c', '#95a5a6', '#ffffff'];
        ...
        if (container) {
            ...
            for (const color of this.game.state.nextBalls) {
                ...
                if (this.renderer.currentSkin === 'classic') {
                    ...
                    // 马年马样式
                    const horseColors = ['#c0392b', '#1d3557', '#27ae60', '#e9c46a', '#9b5de5', '#f4a261', '#1abc9c', '#95a5a6', '#ffffff'];
